...
Item {
    ...
    function handleFloatingWindowAction(windowDelegate, targetWs, sourceWs) {
        if (targetWs !== -1 && targetWs !== sourceWs) {
            ...
            HyprlandDispatch.dispatch(HyprlandDispatch.moveToWorkspace(windowDelegate.address, targetWs, true));
        } else {
            ...
            HyprlandDispatch.dispatch(HyprlandDispatch.moveToPixel(windowDelegate.address, absoluteX, absoluteY));
        }
        return true;
    }
                            ...
                            MouseArea {
                                ...
                                onPressed: {
                                    if (root.draggingTargetWorkspace === -1) {
                                        OverviewState.close();
                                        HyprlandDispatch.dispatch(HyprlandDispatch.focusWorkspace(workspace.workspaceValue));
                                    }
                                }
                            }
                    ...
                    MouseArea {
                        ...
                        onClicked: (event) => {
                            ...
                            if (event.button === Qt.MiddleButton) {
                                ...
                                HyprlandDispatch.dispatch(HyprlandDispatch.closeWindow(windowDelegate.winData.address));
                                event.accepted = true;
                                ...
                                if (primaryHeld && secondaryHeld) {
                                    ...
                                    OverviewState.close();
                                    HyprlandDispatch.dispatch(HyprlandDispatch.focusWindow(windowDelegate.winData.address));
                                    event.accepted = true;
                                }
                            }
                        }
