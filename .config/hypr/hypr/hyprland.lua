...
hl.on("hyprland.start", function()
  ...
  hl.exec_cmd("sleep 1 && /home/eternity/.config/waybar/start.sh > /home/eternity/waybar.log")
...
hl.env("LANG", "zh_CN.UTF-8")              -- 系统语言设为中文
hl.env("LANGUAGE", "zh_CN.UTF-8")          -- 应用语言优先中文
hl.env("LC_ALL", "zh_CN.UTF-8")            -- 所有 locale 设为中文
hl.env("GTK_IM_MODULE", "fcitx")           -- GTK 应用输入法
hl.env("QT_IM_MODULE", "fcitx")            -- Qt 应用输入法
hl.env("XMODIFIERS", "@im=fcitx")          -- 通用输入法模块
...
hl.bind(mainMod .. " + C",
  hl.dsp.exec_cmd("WLR_NO_HARDWARE_CURSORS=1 /home/eternity/bin/clipman pick --tool=wofi -T='-p Clip History'"))
...
hl.bind(mainMod .. " + R", hl.dsp.exec_cmd("~/.config/rofi/scripts/powermenu.sh 2>/tmp/powermenu.err"))
...
hl.bind(mainMod .. " + SHIFT + S",
  hl.dsp.exec_cmd(
    "bash -c 'mkdir -p ~/Pictures/Screenshots && grim -g \"$(slurp)\" ~/Pictures/Screenshots/$(date +%Y%m%d_%H%M%S).png | wl-copy'"),
